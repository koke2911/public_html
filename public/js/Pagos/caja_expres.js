...
function buscar_deuda_rut() {
    var rut_socio = $("#txt_rut_socio").val();

    $("#grid_deuda").dataTable().fnReloadAjax(base_url + "/Pagos/Ctrl_caja/datatable_deuda_socioRut/" + rut_socio);
...
$(document).ready(function() {
    ...
    $("#txt_rut_socio").attr("placeholder", "Sin puntos, ni guion");

    $("#txt_id_socio").prop("disabled", true);
    $("#txt_rut_socio").prop("disabled", false);
	...
	$("#btn_buscar_deuda").on("click", function() {

        if($("#txt_rut_socio").val()!=""){
            $.ajax({
                    url: base_url + "/Pagos/Ctrl_caja/buscar_datos_socio",
                    type: "POST",
                    async: false,
                    dataType: "json",
                    data: {
                        rut_socio: $("#txt_rut_socio").val()
                    },
            ...
            alerta.aviso("alerta", "Debe indicar el rut del socio");
        }
    });

 // $("#txt_rut_socio").on("click", function() {
