  ...
  <body onload="init()">
      ...
      <div class="tab-content">
        ...
        <div class="content" id="server">
          <?php foreach ([
                          '_SERVER',
                          '_SESSION'
                         ] as $var) : ?><?php if (empty($GLOBALS[$var]) || !is_array($GLOBALS[$var])) {
            continue;
          } ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php if (is_string($value)) : ?>
                        <?= htmlspecialchars($value, ENT_SUBSTITUTE, 'UTF-8') ?><?php else: ?>
                        <?= '<pre>' . print_r($value, TRUE) ?><?php endif; ?>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
        ...
        <div class="content" id="request">
          ...
          <?php if (!empty($headers)) : ?>
            ...
            <table>
              ...
              <tbody>
                <?php foreach ($headers as $value) : ?><?php if (empty($value)) {
                  continue;
    ...
    <div class="footer">
      <div class="container">
        ...
        <p>
          Displayed at <?= date('H:i:sa') ?> &mdash; PHP: <?= phpversion() ?> &mdash; CodeIgniter: <?= \CodeIgniter\CodeIgniter::CI_VERSION ?>
        </p>
