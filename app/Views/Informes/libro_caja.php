<main>
  ...
  <div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
      <div class="card mb-4">
        <div class="card-header">
          <i class="fas fa-file-excel"></i> Informe de caja simple
        </div>
        <div class="card shadow mb-12 " id="datorReporte">
          <div class="card-body">
            <div class="container-fluid">
              <form id="form_libro" name="form_libro" encType="multipart/form-data">
                <div class="row">
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                    <div class="form-group">
                      <label class="small mb-1" for="dt_inicio">Inicio</label>
                      <input type='text' class="form-control" id='dt_inicio' name="dt_inicio" />
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12">
                    <div class="form-group">
                      <label class="small mb-1" for="dt_fin">Fin</label>
                      <input type='text' class="form-control" id='dt_fin' name="dt_fin" />
                    </div>
                  </div>
                  <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12">
                    <div class="form-group">
                      <label class="small mb-1" for="btn_export_simple">Exportar</label><BR>
                      <button type="button" name="btn_export_simple" id="btn_export_simple" class="btn btn-success"><i class="fas fa-file-excel">Excel</i></button>
                    </div>
                  </div>
                </div>
